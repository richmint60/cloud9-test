...
vc_lean_map( 'ctitle', null, $vc_config_path . '/nimva/title.php' );
vc_lean_map( 'qbox', null, $vc_config_path . '/nimva/quote-box.php' );
vc_lean_map( 'vc_button', null, $vc_config_path . '/nimva/button.php' );
vc_lean_map( 'tagline_box', null, $vc_config_path . '/nimva/call-action.php' );
vc_lean_map( 'vc_separator', null, $vc_config_path . '/nimva/separator.php' );
vc_lean_map( 'vc_message', null, $vc_config_path . '/nimva/message.php' );
vc_lean_map( 'recent_posts', null, $vc_config_path . '/nimva/posts-grid.php' );
vc_lean_map( 'recent_works', null, $vc_config_path . '/nimva/portfolio.php' );
vc_lean_map( 'vc_service_box', null, $vc_config_path . '/nimva/featured-services.php' );
vc_lean_map( 'product_feature', null, $vc_config_path . '/nimva/product-feature.php' );
vc_lean_map( 'faqs', null, $vc_config_path . '/nimva/faq.php' );
vc_lean_map( 'vc_gmaps', null, $vc_config_path . '/nimva/gmaps.php' );
vc_lean_map( 'social_links', null, $vc_config_path . '/nimva/social-links.php' );
vc_lean_map( 'clients', null, $vc_config_path . '/nimva/clients.php' );
vc_lean_map( 'testimonials', null, $vc_config_path . '/nimva/testimonials.php' );
vc_lean_map( 'pricing_table', null, $vc_config_path . '/nimva/pricing-table.php' );
vc_lean_map( 'employee', null, $vc_config_path . '/nimva/employee.php' );
vc_lean_map( 'vc_toggle', null, $vc_config_path . '/nimva/toggle.php' );

vc_lean_map( 'vc_wp_flickr_widget', null, $vc_config_path . '/nimva/widget-flickr.php' );
vc_lean_map( 'vc_wp_custom_posts', null, $vc_config_path . '/nimva/widget-posts.php' );
vc_lean_map( 'vc_wp_custom_portf', null, $vc_config_path . '/nimva/widget-portfolio.php' );
vc_lean_map( 'vc_wp_rec_pop_tabs', null, $vc_config_path . '/nimva/widget-popular-tab.php' );
vc_lean_map( 'vc_wp_contact_us', null, $vc_config_path . '/nimva/widget-contact.php' );
vc_lean_map( 'vc_wp_social_links', null, $vc_config_path . '/nimva/widget-social.php' );
vc_lean_map( 'vc_wp_twitter_feed', null, $vc_config_path . '/nimva/widget-twitter.php' );
