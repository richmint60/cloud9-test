...
class WPBakeryShortCode_VC_Row extends WPBakeryShortCode {
	 ...
	 * @return string
	 */
	public function buildStyle( $bg_image = '', $bg_color = '', $paddingtop = '', $paddingbottom = '', $marginbottom = '', $margintop = '', $bg_attachment = '', $bg_stretch = '', $bg_patterns = '', $row_font_color ) {
		...
		if ( '' !== $paddingtop ) {
			$style .= 'padding-top: ' . ( preg_match( '/(px|em|\%|pt|cm)$/', $paddingtop ) ? $paddingtop : $paddingtop . 'px' ) . ';';
		}
		if ( '' !== $paddingbottom ) {
			$style .= 'padding-bottom: ' . ( preg_match( '/(px|em|\%|pt|cm)$/', $paddingbottom ) ? $paddingbottom : $paddingbottom . 'px' ) . ';';
		}
		
		if ( '' !== $margintop ) {
			$style .= 'margin-top: ' . ( preg_match( '/(px|em|\%|pt|cm)$/', $margintop ) ? $margintop : $margintop . 'px' ) . ';';
		}
		if ( '' !== $marginbottom ) {
			$style .= 'margin-bottom: ' . ( preg_match( '/(px|em|\%|pt|cm)$/', $marginbottom ) ? $marginbottom : $marginbottom . 'px' ) . ';';
		}
		if( '' !== $bg_attachment ) {
		...
		if( !empty( $row_font_color ) ) {
			$style .= 'color:'.$row_font_color.';';
		}
