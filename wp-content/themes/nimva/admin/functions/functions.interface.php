...
function optionsframework_add_admin() {
    ...
    $of_page = add_menu_page( THEMENAME, 'Theme Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page',get_template_directory_uri().'/admin/assets/images/logo.png',62);
