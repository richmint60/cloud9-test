...
/*-----------------------------------------------------------------------------------*/
	...
	function __construct() {
		...
		$widget_ops = array( 
		    ...
		    'description' => __('A widget that displays your recent portfolios.', 'Nimva') 
		);
		...
		/* Create the widget. */
		//$this->WP_Widget( 'tz_recent_portfolios_widget', __('Custom Recent Portfolios Widget', 'Nimva'), $widget_ops, $control_ops );
		parent::__construct( 'tz_recent_portfolios_widget', __('Custom Recent Portfolios Widget', 'Nimva'), $widget_ops, $control_ops );
	}
...
?>
		<?php //if( !empty($desc) ) { echo "<p>$desc</p>"; } ?>
			...
			<div class="custom_recent_posts">                
                <div id="widget-portfolio" class="portfolio-widget-scroll" data-prev="#widget-portfolio-prev" data-next="#widget-portfolio-next">
                <?php
