...
if( ! class_exists( 'FusionMegaMenuFramework' ) ) {
    ...
    class FusionMegaMenuFramework {
		...
		function register_scripts() {
			...
			// scripts
			wp_enqueue_media();
			wp_register_script( 'megamenu', self::$_urls['admin-js'] . '/mega-menu.js', array( 'jquery' ), '1.0.0', true );
		...
		function register_stylesheets() {
			...
			wp_enqueue_style( 'megamenu', self::$_urls['admin-css'] . '/mega-menu.css', false, '1.0' );
