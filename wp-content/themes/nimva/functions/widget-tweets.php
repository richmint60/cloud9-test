...
class Tweets_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
        ...
        <p class="nobottommargin topmargin2 tright"><a href="http://twitter.com/<?php echo $cr_twitter_username; ?>" class="ntip" title="Follow <?php echo $twitter_id; ?> on Twitter">Follow on Twitter →</a></p>
