                                    ...
                                    <div class="portfolio-item  <?php echo $item_classes; ?>">	 
										...
										?>
                                            <div class="portfolio-title">
                                                <h3 title="<?php echo get_the_title(); ?>"><a href="<?php echo $title_link; ?>" <?php echo $target; ?>><?php echo get_post_meta($post->ID, 'pyre_portfolio_details', true).get_the_title(); ?></a></h3>
