...
<?php endif; ?>
		...
		<div class="title-outer"><h3><?php _e( 'Login', 'woocommerce' ); ?></h3></div>
		...
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				<input type="submit" class="simple-button default_color small inverse" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-2">
		...
		<div class="title-outer"><h3><?php _e( 'Register', 'woocommerce' ); ?></h3></div>
