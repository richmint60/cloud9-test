...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<div class="title-outer"><h3><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></h3></div>
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="simple-button default_color small inverse"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
